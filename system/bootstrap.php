...
$allowed_domains = array(
    'nuez.do', 'nuez.ss', 'nuez.intimo.doubleoneweb.com.br',
    'vibrancefit.com.br', 'vibrance.ss', 'vibrance.intimo.doubleoneweb.com.br',
    'milan.do', 'milan.ss', 'milan.intimo.doubleoneweb.com.br',
    'instintointimo.do', 'instintointimo.ss',
);
$default_domain = 'vibrancefit.com.br';
...
$site = new \App\Models\Back\SiteModel;
define('SITEENABLED', $site->select('id')->where('site', $domain)->first()['id']);
define('SITESLUG', $site->select('slug')->where('site', $domain)->first()['slug']);
define('URLRESTRIC', preg_match('/^((?!(admin|api)).)*$/', $_SERVER['REQUEST_URI']));
