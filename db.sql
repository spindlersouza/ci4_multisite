...
-- Copiando estrutura do banco de dados para instintointimo
CREATE DATABASE IF NOT EXISTS `instintointimo` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `instintointimo`;

-- Copiando estrutura para tabela instintointimo.cidade
CREATE TABLE IF NOT EXISTS `cidade` (
  ...
  CONSTRAINT `estado` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5570 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela instintointimo.cidade: ~5.568 rows (aproximadamente)
...
INSERT INTO `cidade` (`id`, `nome`, `estado_id`) VALUES
	...
	(5267, 'São Luíz do Paraitinga', 26),
	(5268, 'São Manuel', 26),
...
-- Copiando estrutura para tabela instintointimo.configuracao
CREATE TABLE IF NOT EXISTS `configuracao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cep_remetente` char(10) NOT NULL,
  `pagseguro_ambiente` char(1) NOT NULL DEFAULT 's',
  `pagseguro_email` varchar(150) NOT NULL,
  `pagseguro_token` varchar(150) NOT NULL,
  `email_notificacao` varchar(150) NOT NULL,
  `email_notificacao_copia` varchar(150) DEFAULT NULL,
  `email_notificacao_copia_oculta` varchar(150) DEFAULT NULL,
  `servidor_smtp` varchar(150) NOT NULL,
  `servidor_smtp_porta` char(5) NOT NULL,
  `mailer_email` varchar(150) NOT NULL,
  `mailer_senha` varchar(50) NOT NULL,
  `arquivo` varchar(150) NOT NULL,
  `arquivo2` varchar(150) NOT NULL,
  `texto_cadastro` text NOT NULL,
  `texto_pedido` text NOT NULL,
  `tls` char(1) NOT NULL DEFAULT 't',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela instintointimo.configuracao: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `configuracao` DISABLE KEYS */;
INSERT INTO `configuracao` (`id`, `cep_remetente`, `pagseguro_ambiente`, `pagseguro_email`, `pagseguro_token`, `email_notificacao`, `email_notificacao_copia`, `email_notificacao_copia_oculta`, `servidor_smtp`, `servidor_smtp_porta`, `mailer_email`, `mailer_senha`, `arquivo`, `arquivo2`, `texto_cadastro`, `texto_pedido`, `tls`) VALUES
	(1, '93546-010', 'S', 'eduardo@doubleone.com.br', '123123123', 'eduardo@doubleone.com.br', 'eduardo@doubleone.com.br', 'eduardo@doubleone.com.br', 'smtp.doubleoneweb.com.br', '587', 'noreply2@doubleoneweb.com.br', 'mailer587@21', 'qwe', 'qwe', '<p>&Eacute; uma grande satisfa&ccedil;&atilde;o ter voc&ecirc; como nosso cliente. A PARTIR DE AGORA, UTILIZE SEU E-MAIL E SUA SENHA para acessar seu PAINEL DE CONTROLE, acompanhar os seus PEDIDOS ou gerenciar o seu CADASTRO.</p>', '<p>A compra que voc&ecirc; realizou est&aacute; vinculada &agrave; aprova&ccedil;&atilde;o do PAGSEGURO. Ap&oacute;s a confirma&ccedil;&atilde;o do pagamento, enviamos seu pedido imediatamente.<br />\r\n<br />\r\nEsta mensagem &eacute; exclusiva &agrave; pessoa a quem foi destinada, podendo haver informa&ccedil;&otilde;es confidenciais e/ou legalmente protegidas. Se voc&ecirc; n&atilde;o for o destinat&aacute;rio, &eacute; notificado que n&atilde;o deve fazer c&oacute;pias, divulga&ccedil;&otilde;es, verifica&ccedil;&otilde;es ou qualquer outro ato de mesma esp&eacute;cie, com o objetivo de utilizar estas informa&ccedil;&otilde;es. Por favor, caso tenha havido o engano, desde j&aacute;, &eacute; importante que remova as informa&ccedil;&otilde;es de seus servidores e/ou banco de dados, precavendo-se assim de acarretamentos legais.</p>', 't');
/*!40000 ALTER TABLE `configuracao` ENABLE KEYS */;

-- Copiando estrutura para tabela instintointimo.estado
...
-- Copiando dados para a tabela instintointimo.estado: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela instintointimo.filial
CREATE TABLE IF NOT EXISTS `filial` (
  ...
  `mapa` varchar(3000) DEFAULT NULL,
  `atendimento` text,
  `slogan` varchar(150) DEFAULT NULL,
  `emails` text,
  `telefones` text,
  `whatsapp_processos` varchar(150) DEFAULT NULL,
  `protocolo` int(11) DEFAULT NULL,
  `api_key` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela instintointimo.filial: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `filial` DISABLE KEYS */;
/*!40000 ALTER TABLE `filial` ENABLE KEYS */;

-- Copiando estrutura para tabela instintointimo.informacao_site
CREATE TABLE IF NOT EXISTS `informacao_site` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `facebook` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `instagram` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `twitter` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `linkedin` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `youtube` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `telefone` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `whatsapp` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `endereco` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `cidade_id` int(11) DEFAULT NULL,
  `mapa` varchar(3000) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `atendimento` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `slogan` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `emails` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `telefones` text CHARACTER SET latin1 COLLATE latin1_general_ci,
  `whatsapp_processos` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `protocolo` int(11) DEFAULT NULL,
  `api_key` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
...
-- Copiando dados para a tabela instintointimo.informacao_site: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `informacao_site` DISABLE KEYS */;
INSERT INTO `informacao_site` (`id`, `nome`, `facebook`, `instagram`, `twitter`, `linkedin`, `youtube`, `email`, `telefone`, `whatsapp`, `endereco`, `cidade_id`, `mapa`, `atendimento`, `slogan`, `emails`, `telefones`, `whatsapp_processos`, `protocolo`, `api_key`, `created_at`, `updated_at`) VALUES
	(1, 'Instinto Intimo', 'https://www.facebook.com/', 'https://www.instagram.com/conradofrj/', '', '', 'https://www.youtube.com/channel/', 'conrado@cdi.adv.br', '(51) 3221-5209', '(51) 99749-3978', '<p>Rua Padre Chagas, 79 / 701</p>\r\n\r\n<p>Bairro Moinhos de Vento</p>\r\n\r\n<p>CEP 90570-080</p>\r\n\r\n<p>(51) 3019.5050</p>\r\n', 4174, '<iframe src=', '<p>Segunda - 8h - 18h</p>\r\n\r\n<p>Ter&ccedil;a -&nbsp;8h - 18h</p>\r\n\r\n<p>Quarta&nbsp;-&nbsp;8h - 18h</p>\r\n\r\n<p>Quinta -&nbsp;8h - 18h</p>\r\n\r\n<p>Sexta -&nbsp;8h - 17h</p>\r\n', 'Especializado em soluções empresariais', NULL, '<p>R. Ana Pernigotti, 1061</p>\r\n\r\n<p>Cond. Pq. do Lago,&nbsp;Rua H, casa 7</p>\r\n\r\n<p>Bolaxa&nbsp;- Rio Grande/RS&nbsp;</p>\r\n\r\n<p>CEP: 96217.010</p>\r\n', '', 0, '', '2022-02-02 16:11:42', '2022-02-02 16:12:13');
/*!40000 ALTER TABLE `informacao_site` ENABLE KEYS */;

-- Copiando estrutura para tabela instintointimo.nivel_acesso
...
-- Copiando dados para a tabela instintointimo.nivel_acesso: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `nivel_acesso` DISABLE KEYS */;
INSERT INTO `nivel_acesso` (`id`, `permissao`, `created_at`, `updated_at`) VALUES
	(1, 'Administrador', '2022-02-01 14:32:36', '2022-02-01 14:32:36'),
	(2, 'Gerenciador', '2022-02-01 14:32:36', '2022-02-01 14:32:36');
/*!40000 ALTER TABLE `nivel_acesso` ENABLE KEYS */;

-- Copiando estrutura para tabela instintointimo.usuarios
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  KEY `usuario_criador` (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela instintointimo.usuarios: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `nome`, `email`, `login`, `senha`, `usuario_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Eduardo', 'spindlersouza@gmail.com', 'eduardo', '$2y$10$efaBlDZDlIBLAMsVDxkIbOnxA4wF1c6w7L7BgIzttt5/UczfmJLc.', 1, '2022-02-01 23:49:48', '2022-02-03 13:23:45', NULL);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;

-- Copiando estrutura para tabela instintointimo.usuarios_permissoes
CREATE TABLE IF NOT EXISTS `usuarios_permissoes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario_id` int(11) NOT NULL,
  `modulo_id` int(11) DEFAULT NULL,
  `nivel_acesso_id` int(11) DEFAULT NULL,
  `created_usuario_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `usuario_relacionado` (`usuario_id`),
  KEY `permissao_relacionada` (`nivel_acesso_id`),
  KEY `usuario_criador` (`created_usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela instintointimo.usuarios_permissoes: ~0 rows (aproximadamente)
