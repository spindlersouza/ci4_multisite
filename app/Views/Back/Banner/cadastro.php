...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="javascript:window.history.go(-1);">Banner</a></li>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <br /><br />
        <form enctype="multipart/form-data" action="<?php echo base_url('admin/banner/save'); ?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        <label>Imagem Desktop<small>[ Dimensões: 1920x650px ]</small></label>
                        <a href="#" class="fancybox btn btn-default"><i class="fa fa-picture-o roxo"></i></a>
                        ...
                        <span class="btn btn-default btn-file btn-file-lg">
                            ...
                            <span class="text-danger">
                                <?php echo isset($validation) ? display_errors($validation, 'banner') : ''; ?>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="btn btn-default btn-file btn-file-lg">
                            ...
                            <span class="text-danger">
                                <?php echo isset($validation) ? display_errors($validation, 'banner_mobile') : ''; ?>
