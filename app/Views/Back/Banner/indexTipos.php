...
<div class="row">
    <div class="col-xs-12">
        <a href="<?php echo base_url('admin/banner/cadastroTipos/' . $tipo_id); ?>"> <button class="btn btn-sm btn-primary">Cadastrar</button> </a>
                ...
                <tbody>
                    <?php foreach ($banners as $result) : ?>
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('admin/banner/cadastroTipos/' . $tipo_id . '/' . $result['id']); ?>"><i class="fa fa-edit"></i></a></td>									
                            <td><a href="<?php echo base_url('admin/banner/delete/' . $result['id'] . '/' . $tipo_id); ?>"><i class="fa fa-trash"></i></a></td>									
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
