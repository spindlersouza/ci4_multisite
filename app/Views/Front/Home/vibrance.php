...
<?php if ($banners_meio) : ?>
    <div class="row-countdown bg-banners" style="
    ...
    <div class="row-countdown bg-banners-m" style="
...
<?php if ($banners_baixo) : ?>
    <div class="row-countdown bg-banners" 
         style="background: url('<?php echo base_url('public/upload/banner/' . $banners_baixo['banner']); ?>') no-repeat center center;">
        <div class=" h-100"><a href="<?php echo $banners_baixo['link'] ?? '#'; ?>"><div class="box-slider"></div></a></div>
    </div>
    <div class="row-countdown bg-banners-m" style="background: url('<?php echo base_url('public/upload/banner/' . $banners_baixo['banner_mobile']); ?>') no-repeat center center;">
        <div class=" h-100"><a href="<?php echo $banners_baixo['link'] ?? '#'; ?>"><div class="box-slider"></div></a></div>
    </div>
<?php endif; ?>
...
<?php if ($banners_baixo_rodape) : ?>
    <section class="row">
        <?php foreach ($banners_baixo_rodape as $bannerBR) : ?>
            <div class="col-md-6 row-countdown py-0 bg-section anime-down" style="background: url(<?php echo base_url('public/upload/banner/' . $bannerBR['banner']); ?>) no-repeat center center;">
                <div class="h-100">
