...
class PoliticaTrocas extends BaseController {
    ...
    public function __construct() {
        ...
        $this->data = [
            ...
            SITESLUG => 'active',
            'linksite' => $rsSites,
            'paginas' => $this->paginas->where('slug', 'trocas-devolucoes')->where('site_id', SITEENABLED)->first(),
    ...
    public function index() {
        ...
        return view('Front/PoliticaTrocas/index', $this->data);
    }
