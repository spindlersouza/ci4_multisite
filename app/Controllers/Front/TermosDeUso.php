...
class TermosDeUso extends BaseController {
    ...
    public function __construct() {
        ...
        $this->data = [
            ...
            SITESLUG => 'active',
            'linksite' => $rsSites,
            'paginas' => $this->paginas->where('slug', 'termos-uso')->where('site_id', SITEENABLED)->first(),
    ...
    public function index() {
        ...
        return view('Front/TermosDeUso/index', $this->data);
    }
