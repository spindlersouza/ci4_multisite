var jscolor = {
    ...
    color: function (target, prop) {
        ...
        function drawPicker(x, y) {
            ...
            p.padM.style.backgroundImage = "url('../img/" + jscolor.getDir() + "cross.gif')";
            p.padM.style.backgroundRepeat = "no-repeat";
            p.sldM.style.backgroundImage = "url('../img/" + jscolor.getDir() + "arrow.gif')";
            p.sldM.style.backgroundRepeat = "no-repeat";
            p.pad.style.backgroundImage = "url('../img/" + jscolor.getDir() + padImg + "')";
